...
def _get_absolute_mapping(name: str):
    ...
    # e.g., `m2models.tasks.base_task.BaseTask`
    # we can use importlib to get the module (e.g., `m2models.tasks.base_task`)
...
class Registry:
    ...
    def register_task(cls, name):
        ...
        Usage::
            from m2models.common.registry import registry
            from m2models.tasks import BaseTask
    ...
    def register_dataset(cls, name):
        ...
        Usage::
            ...
            from m2models.common.registry import registry
            from m2models.datasets import BaseDataset
    ...
    def register_model(cls, name):
        ...
        Usage::
            ...
            from m2models.common.registry import registry
            from m2models.modules.layers import CGCNNConv
    ...
    def register_logger(cls, name):
        ...
        def wrap(func):
            from m2models.common.logger import Logger
    ...
    def __import_error(cls, name: str, mapping_name: str):
        ...
        if existing_cls_path is not None:
            ...
            existing_cls_path = "m2models.trainers.ForcesTrainer"
    ...
    def get_class(cls, name: str, mapping_name: str):
        ...
        # mapping be class path of type `{module_name}.{class_name}` (e.g., `m2models.trainers.ForcesTrainer`)
        if name.count(".") < 1:
